...
_1603: x0 => x0.click(),
_1604: x0 => globalThis.URL.createObjectURL(x0),
_1605: (x0,x1) => x0.getItem(x1),
_1607: (x0,x1,x2) => x0.setItem(x1,x2),
...
_1695: s => JSON.stringify(s),
_1696: s => printToConsole(s),
_1697: a => a.join(''),
_1698: (o, a, b) => o.replace(a, b),
_1700: (s, t) => s.split(t),
_1701: s => s.toLowerCase(),
_1702: s => s.toUpperCase(),
_1703: s => s.trim(),
_1704: s => s.trimLeft(),
_1705: s => s.trimRight(),
_1707: (s, p, i) => s.indexOf(p, i),
_1708: (s, p, i) => s.lastIndexOf(p, i),
_1709: (s) => s.replace(/\$/g, "$$$$"),
_1710: Object.is,
...
_1713: (a, i) => a.push(i),
_1717: a => a.pop(),
_1718: (a, i) => a.splice(i, 1),
_1720: (a, s) => a.join(s),
_1721: (a, s, e) => a.slice(s, e),
_1723: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
_1724: a => a.length,
_1726: (a, i) => a[i],
_1727: (a, i, v) => a[i] = v,
_1729: (o, offsetInBytes, lengthInBytes) => {
...
_1771: x0 => new Uint8Array(x0),
_1772: () => globalThis.crypto,
...
_1796: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
_1797: (x0,x1) => x0.send(x1),
_1799: x0 => x0.getAllResponseHeaders(),
_1800: x0 => globalThis.URL.createObjectURL(x0),
_1802: x0 => ({type: x0}),
_1803: (x0,x1) => new Blob(x0,x1),
_1804: () => new XMLHttpRequest(),
_1805: x0 => x0.send(),
_1807: () => new FileReader(),
_1808: (x0,x1) => x0.readAsArrayBuffer(x1),
_1809: (x0,x1) => x0.item(x1),
_1810: (x0,x1) => x0.removeChild(x1),
...
_1818: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
_1819: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
_1825: (x0,x1) => x0.appendChild(x1),
_1826: x0 => x0.click(),
