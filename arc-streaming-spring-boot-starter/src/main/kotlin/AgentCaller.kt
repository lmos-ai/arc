...
import ai.ancf.lmos.arc.ws.inbound.convert
import ai.ancf.lmos.arc.ws.inbound.convertAPIEntities
import ai.ancf.lmos.arc.ws.inbound.convertConversationEntities
import ai.ancf.lmos.arc.ws.inbound.toMessage
...
class AgentCaller(
     ...
     */
    fun callAgent(agentName: String? = null, request: AgentRequest, dataStream: WritableDataStream) =
        channelFlow {
            coroutineScope {
